  ...
  return (
    <>
      ...
      >
        ...
        hetthuongcannho.doc
        <img
          src="https://firebasestorage.googleapis.com/v0/b/duan-ede31.appspot.com/o/x.png?alt=media&token=5201a378-2b76-4681-8942-6a822aca7da6"
          alt="x"
        />
        <br />
        <i
...
export default ChinhSuaHopDong;
